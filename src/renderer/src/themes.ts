...
export interface ThemeOverlay {
  recordingStyle: 'bars' | 'wave' | 'scope'     // бары, синусоида, осциллограф
  processingStyle: 'tunnel' | 'wave' | 'scope'  // тоннель, синусоида, осциллограф
  gradient: string
  waveColor: string
  dotColor: string
  dotGlow: string
...
export interface Theme {
  ...
  text4: string
  accent: string
  accentOnBg: string      // цвет текста НА акцентном фоне
  accentBg: string
...
export const themes: Theme[] = [
  {
    ...
    border: 'rgba(255,255,255,0.15)', borderStrong: 'rgba(255,255,255,0.25)',
    text1: '#ffffff', text2: 'rgba(255,255,255,0.85)', text3: 'rgba(255,255,255,0.6)', text4: 'rgba(255,255,255,0.4)',
    accent: '#fbbf24', accentOnBg: '#fbbf24', accentBg: 'rgba(251,191,36,0.18)', accentBgHover: 'rgba(251,191,36,0.28)', accentBorder: 'rgba(251,191,36,0.35)',
    blobs: { enabled: true, count: 5, sizeMultiplier: 1, speed: 1, blur: 80, opacity: 1,
  ...
  },
  {
    ...
    text1: '#f0f9ff', text2: 'rgba(224,242,255,0.85)', text3: 'rgba(186,220,245,0.6)', text4: 'rgba(148,200,235,0.4)',
    accent: '#38bdf8', accentOnBg: '#38bdf8', accentBg: 'rgba(56,189,248,0.18)', accentBgHover: 'rgba(56,189,248,0.28)', accentBorder: 'rgba(56,189,248,0.35)',
    blobs: { enabled: true, count: 5, sizeMultiplier: 1, speed: 0.7, blur: 100, opacity: 0.8,
  ...
  },
  {
    ...
    text1: '#ecfdf5', text2: 'rgba(209,250,229,0.85)', text3: 'rgba(167,230,200,0.6)', text4: 'rgba(130,210,180,0.4)',
    accent: '#34d399', accentOnBg: '#34d399', accentBg: 'rgba(52,211,153,0.18)', accentBgHover: 'rgba(52,211,153,0.28)', accentBorder: 'rgba(52,211,153,0.35)',
    blobs: { enabled: true, count: 5, sizeMultiplier: 1.2, speed: 0.5, blur: 120, opacity: 0.7,
  ...
  },
  {
    ...
    border: 'rgba(255,255,255,0.1)', borderStrong: 'rgba(255,255,255,0.2)',
    text1: '#eef2ff', text2: 'rgba(224,231,255,0.85)', text3: 'rgba(186,200,255,0.6)', text4: 'rgba(148,170,240,0.4)',
    accent: '#a78bfa', accentOnBg: '#a78bfa', accentBg: 'rgba(167,139,250,0.18)', accentBgHover: 'rgba(167,139,250,0.28)', accentBorder: 'rgba(167,139,250,0.35)',
    blobs: { enabled: true, count: 5, sizeMultiplier: 0.9, speed: 0.8, blur: 90, opacity: 0.9,
  ...
  },
  {
    ...
    border: 'rgba(0,230,118,0.25)', borderStrong: 'rgba(0,230,118,0.4)',
    text1: '#f0fff0', text2: 'rgba(220,255,220,0.85)', text3: 'rgba(180,255,200,0.6)', text4: 'rgba(140,220,180,0.4)',
    accent: '#00e676', accentOnBg: '#00e676', accentBg: 'rgba(0,230,118,0.2)', accentBgHover: 'rgba(0,230,118,0.3)', accentBorder: 'rgba(0,230,118,0.38)',
    blobs: { enabled: true, count: 5, sizeMultiplier: 0.8, speed: 1.5, blur: 60, opacity: 1,
  ...
  },
  {
    ...
    surfacePanel: '#c0c0c0',
    border: '#808080', borderStrong: '#404040',
    text1: '#000000', text2: '#000000', text3: '#404040', text4: '#808080',
    accent: '#000080', accentOnBg: '#ffffff', accentBg: '#000080', accentBgHover: '#0000a0', accentBorder: '#000080',
    blobs: { enabled: false, count: 0, sizeMultiplier: 0, speed: 0, blur: 0, opacity: 0, colors: [] },
    noise: { enabled: false, intensity: 0, sparkles: false, sparkleDensity: 0, sparkleIntensity: 0 },
    ...
    overlay: { recordingStyle: 'scope', processingStyle: 'scope', gradient: '#1a1a1a', waveColor: 'rgba(0,255,65,0.85)', dotColor: '#00ff41', dotGlow: 'rgba(0,255,65,0.5)', textColor: '#00ff41', radius: 0 }
  }
]
...
export function applyTheme(theme: Theme): void {
  ...
  r.setProperty('--accent-on-bg', theme.accentOnBg)
