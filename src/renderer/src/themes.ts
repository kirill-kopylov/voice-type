...
export const themes: Theme[] = [
  {
    ...
    accent: '#fbbf24', accentBg: 'rgba(251,191,36,0.18)', accentBgHover: 'rgba(251,191,36,0.28)', accentBorder: 'rgba(251,191,36,0.35)',
  ...
  },
  {
    ...
    accent: '#38bdf8', accentBg: 'rgba(56,189,248,0.18)', accentBgHover: 'rgba(56,189,248,0.28)', accentBorder: 'rgba(56,189,248,0.35)',
  ...
  },
  {
    ...
    accent: '#34d399', accentBg: 'rgba(52,211,153,0.18)', accentBgHover: 'rgba(52,211,153,0.28)', accentBorder: 'rgba(52,211,153,0.35)',
  ...
  },
  {
    ...
    accent: '#a78bfa', accentBg: 'rgba(167,139,250,0.18)', accentBgHover: 'rgba(167,139,250,0.28)', accentBorder: 'rgba(167,139,250,0.35)',
  ...
  },
  {
    ...
    accent: '#00e676', accentBg: 'rgba(0,230,118,0.2)', accentBgHover: 'rgba(0,230,118,0.3)', accentBorder: 'rgba(0,230,118,0.38)',
  ...
  },
  {
    ...
    accent: '#007aff', accentBg: 'rgba(0,122,255,0.12)', accentBgHover: 'rgba(0,122,255,0.2)', accentBorder: 'rgba(0,122,255,0.3)',
  ...
  },
  {
    ...
    accent: '#000080', accentBg: '#000080', accentBgHover: '#0000a0', accentBorder: '#000080',
    blobs: { enabled: false, count: 0, sizeMultiplier: 0, speed: 0, blur: 0, opacity: 0, colors: [] },
    noise: { enabled: false, intensity: 0, sparkles: false, sparkleDensity: 0, sparkleIntensity: 0 },
