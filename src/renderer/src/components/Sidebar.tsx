...
export function Sidebar({ page, onPageChange, hotkey }: SidebarProps): JSX.Element {
  return (
    <aside className="w-56 glass flex flex-col shrink-0" style={{ background: 'var(--surface-panel)', border: 'none', borderRight: '1px solid var(--border)', borderRadius: 'var(--radius-panel)' }}>
